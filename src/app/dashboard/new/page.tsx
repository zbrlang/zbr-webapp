...
export default function NewBotPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Create new bot
    const botRes = await fetch(`/api/bots/new`, {
      method: "POST",
    ...
    if (file && botId) {
      ...
      await fetch(`/api/bots/${botId}/import`, {
        method: "POST",
        body: formData,
      });
    }
    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1 max-w-xl mx-auto pt-12 px-6 pb-24 w-full">
        ...
        <form
          ...
          className="space-y-8 bg-surface-20 backdrop-blur-sm p-10 rounded-3xl border border-border-50 shadow-2xl"
        >
