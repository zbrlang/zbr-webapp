    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1 max-w-4xl mx-auto pt-12 px-8 pb-12 w-full">
        <div className="mb-8">
          ...
          <h1 className="text-4xl font-black tracking-tight italic uppercase">Account Settings</h1>
        </div>

        <div className="bg-surface-20 backdrop-blur-sm p-8 rounded-3xl border border-border-50 shadow-xl">
          <div className="space-y-12">
            <section className="space-y-6">
              <h3 className="text-xs font-black italic uppercase tracking-widest text-primary/80">General Preferences</h3>
              <div className="space-y-4">
                ...
                >
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">Currently using {isDarkMode ? "Dark" : "Light"} mode.</p>
                  </div>
                  <div className={`h-6 w-11 rounded-full relative transition-colors duration-300 ${isDarkMode ? "bg-primary" : "bg-muted"}`}>
                    <div className={`absolute top-1 h-4 w-4 bg-accent-foreground rounded-full shadow-sm transition-all duration-300 ${isDarkMode ? "right-1" : "left-1"}`}></div>
                  </div>
                </div>
                <div className="flex items-center justify-between p-5 bg-surface-30 rounded-2xl border border-border-50 opacity-40 cursor-not-allowed">
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">Coming soon in production.</p>
                  </div>
            ...
            <section className="space-y-6">
              <h3 className="text-xs font-black italic uppercase tracking-widest text-destructive">Danger Zone</h3>
              <div className="p-8 bg-destructive/5 rounded-3xl border border-destructive/20">
                <h4 className="font-bold text-sm mb-1 text-destructive">Delete Account</h4>
                <p className="text-xs text-muted-foreground mb-8">Permanently remove your account and all associated bot data. This action is irreversible.</p>
                <button 
