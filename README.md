...
This repository provides the central dashboard platform for ZBR, offering a high-performance web interface for managing your Discord bot fleet, creating and editing commands, and launching your bot instantly with the built-in cloud runner.

## Key Features

- **Cloud Execution**: Launch and test your bot instantly with a single click using the integrated ZBR cloud runner, no local setup or CLI required.
...
- **Data Portability**: Full support for project mobility. Prototype in the cloud and export to ZIP for production self-hosting via the ZBR CLI.
