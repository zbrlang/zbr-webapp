...
export default function SettingsTab({
  ...
  const handleDeleteBot = async () => {
    ...
    await mutate(
      "/api/bots",
      (bots: any[] = []) => bots.filter((b) => b.id !== botId),
      { revalidate: false },
    );
  ...
  return (
    <div className="space-y-12">
      <section className="space-y-6">
        <div>
          <h2 className="text-2xl font-bold mb-2 italic uppercase">
            Connection Settings
          </h2>
          <p className="text-muted-foreground text-sm font-medium">
            Configure your bot's core identity and API access.
          </p>
        </div>

        <form
          onSubmit={handleSaveConnection}
          className="space-y-8 max-w-2xl bg-surface-30 p-8 rounded-3xl border border-border-50"
        >
          <div className="space-y-3">
              ...
              >
                {showToken ? (
                  ...
                  >
                    <path
                      fillRule="evenodd"
                      d="M3.707 2.293a1 1 0 00-1.414 1.414l14 14a1 1 0 001.414-1.414l-1.473-1.473A10.014 10.014 0 0019.542 10C18.268 5.943 14.476 3 10 3a9.997 9.997 0 00-4.59 1.123L3.707 2.293zM10 13a3 3 0 01-2.977-2.63l4.403 4.403A2.97 2.97 0 0110 13z"
                      clipRule="evenodd"
                    />
                  ...
                  >
                    ...
                    <path
                      fillRule="evenodd"
                      d="M.458 10C1.732 5.943 5.524 3 10 3s8.268 2.943 9.542 7c-1.274 4.057-5.066 7-9.542 7S.458 14.057.458 10z"
                      clipRule="evenodd"
                    />
                  </svg>
                )}
            ...
            <p className="text-[10px] text-muted-foreground italic font-bold">
              Your bot token is used to authenticate with Discord's API. Never
          ...
          <div className="space-y-3">
            ...
            />
            <p className="text-[10px] text-muted-foreground italic font-bold">
              Specify a server ID to limit your bot's operation to a single
              guild.
            </p>
          </div>
      ...
      <section className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground text-sm font-medium">
            Security, Accessibility, and fine-tuned control.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-6">
            <div className="bg-surface-30 p-6 rounded-3xl border border-border-50 space-y-6">
              ...
              <div className="flex items-center justify-between group">
                ...
                >
                  <div
                    className={`absolute top-1 h-4 w-4 bg-accent-foreground rounded-full shadow-sm transition-all duration-300 ${isLoginEnabled ? "right-1" : "left-1"}`}
                  ></div>
                </button>
              </div>
              <button
            ...
            <div className="bg-surface-30 p-6 rounded-3xl border border-border-50">
              <h3 className="text-xs font-black italic uppercase tracking-widest text-primary/80 mb-4">
                Accessibility
              </h3>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-[10px] text-muted-foreground font-medium">
                      Download your bot configuration as a ZIP file.
                    </p>
                  </div>
                  <button
          ...
          <div className="bg-destructive/5 border border-destructive/20 p-8 rounded-3xl flex flex-col justify-between">
            <div>
              <h3 className="text-destructive font-black text-xs italic uppercase tracking-widest mb-4">
                Danger Zone
              </h3>
              <p className="text-muted-foreground text-sm font-medium mb-6">
                Once you delete a bot, there is no going back. All command data
                and variables will be purged.
              </p>
            </div>
